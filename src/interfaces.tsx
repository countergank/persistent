...
export interface ItemDataFilter {
  id: string;
  name: string;
  color?: string;
  icon?: string;
...
export interface EndpointConfig {
  url: string;
  fixedItems?: ItemDataFilter[];
  fieldnames?: ItemDataFilter;
}
...
export interface ComponentInfo {
  ...
  value?: any;
  defaultValue?: any;
  values?: ItemDataFilter[] | EndpointConfig;
  onChange?: (evt: any) => void;
  properties?: ItemProperty[];
  external?: boolean;
  /** @deprecated
   * Esta property se eliminara en una nueva versión.
   * Se debe usar properties, incluyendo {id: 'disabled', value: 'true'}
   */
  disabled?: boolean;
  /** @deprecated
   * Esta property se eliminara en una nueva versión.
   * Se debe usar properties, incluyendo {id: 'multiple', value: 'true'}
   */
  multiple?: boolean;
  /** @deprecated
   * Esta property se eliminara en una nueva versión.
   * Se debe usar properties, por ejemplo: {id: 'required', value: 'true'}
   */
  validations?: ItemValidation[];
  /** @deprecated
   * Esta property se eliminara en una nueva versión.
   * Se debe usar la property "caption"
   */
  label?: string;
  /** @deprecated
   * Esta property se eliminara en una nueva versión.
   * Se debe usar la property "values"
   */
  options?: any;
}

export interface WidgetInfo extends BaseInfo {
  title: string;
  left: number;
  top: number;
  width: number;
...
export interface UserFilter extends BaseInfo {
  appId: string;
  appName?: string;
  componentName?: string;
...
export type IconName = HiddenIconName;
