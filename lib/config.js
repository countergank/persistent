...
var simpleRequest = function (url, method, body, header, timeout, ftoken) {
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            if (!url.endsWith(".json") &&
                ...
                !headers["authorization"]) {
                token = ftoken || ((_a = (0, persistent_1.getUserLoggedInfo)()) === null || _a === void 0 ? void 0 : _a.token) || "";
                if (token && token !== "none") {
            ...
            fetch(url, {
                ...
                .then(function (info) { return __awaiter(void 0, void 0, void 0, function () {
                var data, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            ...
                            reject(__assign(__assign({}, info), { data: data }));
                            return [2];
                    }
                });
            }); })
...
var getConfig = function (path) { return __awaiter(void 0, void 0, void 0, function () {
    var config, info, infoSuite, addConfig;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                config = null;
