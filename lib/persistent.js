...
var httpRequest = function (url, method, body, timeout, header, ftoken) { return __awaiter(void 0, void 0, void 0, function () {
    var config;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2, (0, config_1.simpleRequest)(url, method, body, header, timeout, ftoken)];
        }
    });
}); };
exports.httpRequest = httpRequest;
var appUrl = function (item, config) { return __awaiter(void 0, void 0, void 0, function () {
    var url, infoUser, key;
    var _a, _b;
        ...
        switch (_c.label) {
            case 0:
                ...
                return [4, (0, exports.httpRequest)("".concat(config.APIUser, "/user/session"), "POST", {
                    ...
                    }, undefined, undefined, infoUser.token).catch(function (error) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        url = _a.sent();
                        return [2, (0, exports.httpFiles)(url, body)];
                }
            });
        });
    };
